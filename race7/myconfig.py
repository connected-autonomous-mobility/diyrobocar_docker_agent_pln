...
#GYM_CONF = { "body_style" : "donkey", "body_rgb" : (128, 0, 128), "car_name" : "Parking Lot Nerds", "font_size" : 40, "body_style": "car01"} # body style(donkey|bare|car01) body rgb 0-255
...
#SIM_ARTIFICIAL_LATENCY = 250          # this is the millisecond latency in controls. Can use useful in emulating the delay when useing a remote server. values of 100 to 400 probably reasonable.
# 
...
# AI_THROTTLE_MULT = 0.7              # this multiplier will scale every throttle value for all output from NN models
# 
# #Path following
